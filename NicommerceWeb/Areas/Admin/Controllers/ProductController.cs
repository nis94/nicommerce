...
using Nicommerce.Models.ViewModels;

namespace NicommerceWeb.Areas.Admin.Controllers;
...
public class ProductController : Controller
{
    ...
    {
        bool isUpdate = productVM.Product.Id != 0;
        
        if (!isUpdate && _unitOfWork.Product.Get(p => p.ISBN == productVM.Product.ISBN) != null)
        {
